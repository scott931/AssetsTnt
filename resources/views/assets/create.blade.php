    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-gray-600">Create a new asset record</p>
            </div>
        ...
        <form action="{{ route('assets.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="depreciation_rate" id="depreciation_rate" value="{{ old('depreciation_rate', 0) }}" step="0.01" min="0" required
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
            ...
            <!-- Depreciation -->
            <div class="space-y-4">
                <h3 class="text-lg font-medium text-gray-900">Depreciation</h3>
            ...
            <!-- Files -->
            <div class="space-y-4">
                <h3 class="text-lg font-medium text-gray-900">Files & Documents</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="file" name="receipt" id="receipt" accept=".pdf,.jpg,.jpeg,.png"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        <p class="mt-1 text-sm text-gray-500">PDF, JPG, PNG up to 10MB</p>
                        @error('receipt')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
